OC.L10N.register(
    ...
    "Show photo owner name on timeline" : "Name des Foto-Besitzers auf der Zeitleiste anzeigen",
    "Autoplay Live Photos" : "Live-Fotos automatisch abspielen",
    "Loop Live Photos" : "Live-Photos in Schleife abspielen",
    "Loop Videos" : "Videos in Schleife abspielen",
    ...
    "Slideshow Duration (1-60 seconds)" : "Dauer der Diashow (1-60 Sekunden)",
    ...
    "Day range (1-7)" : "Tagesbereich (1-7)",
    ...
    "You can configure the enabled Nextcloud preview providers below." : "Du kannst die aktiven Nextcloud-Vorschauanbieter unten einrichten.",
    "If you are using Imaginary for preview generation, you can ignore this section." : "Wenn du Imaginary zur Vorschauerstellung verwendest, kannst du diesen Abschnitt überspringen.",
    "To enable RAW support, install the Camera RAW Previews app." : "Um die RAW-Unterstützung zu aktivieren, installiere die Camera RAW Vorschau-App.",
    ...
    "Looks like it has been more than an hour since the last index job was run. Make sure Nextcloud cron is configured correctly." : "Es scheint, dass seit der Ausführung des letzten Indexjobs mehr als eine Stunde vergangen ist. Stelle sicher, dass Nextcloud-Cron richtig konfiguriert ist.",
    ...
    "Memories supports offline reverse geocoding using OpenStreetMap data on MySQL and Postgres." : "Memories unterstützt die Offline-Rückwärtsgeokodierung mit OpenStreetMap-Daten auf MySQL und Postgres.",
    "You need to download the planet data into your database. This is highly recommended and has low overhead." : "Du musst die Planetendaten in deine Datenbank herunterladen. Dies ist sehr zu empfehlen und hat einen geringen Overhead.",
    ...
    "Location search endpoint for metadata editor" : "Standortsuch-Endpunkt für den Metadaten-Editor",
    ...
    "VA-API device path" : "VA-API-Gerätepfad",
    ...
    "Are you sure you want to leave the shared album \"{name}\"?" : "Möchtest du wirklich das geteilte Album \"{name}\" verlassen?",
    "Save" : "Speichern",
    ...
    "Failed to load album info: {name}" : "Albuminformationen von {name} konnten nicht geladen werden ",
    ...
    "Failed to search for location." : "Standortsuche fehlgeschlagen.",
    "Reset" : "Zurücksetzen",
    ...
    "Failed to load metadata for {n} photos." : "Metadaten für {n} Fotos konnten nicht geladen werden",
    ...
    "Failed to load faces" : "Gesichter konnten nicht geladen werden",
    "Create a new face with this name?" : "Ein neues Gesicht mit diesem Namen erstellen?",
    ...
    "You can only merge with a person with name" : "Du kannst nur mit einer Person zusammenfügen, die einen Namen hat",
    ...
    "_{n} item copied to folder_::_{n} items copied to folder_" : ["{n} Element in Ordner kopiert","{n} Elemente in Ordner kopiert"],
    ...
    "Failed to download file for sharing" : "Datei konnte für die Freigabe nicht heruntergeladen werden.",
    ...
    "Upload not permitted" : "Hochladen unzulässig",
    "_Skipped {n} file that already exists_::_Skipped {n} files that already exist_" : ["{n} Datei übersprungen, die bereits existiert","{n} Dateien übersprungen, die bereits existieren"],
    "Uploading {file} ({current}/{total})" : "Lade {file} hoch ({current}/{total})",
    "Upload failed" : "Hochladen fehlgeschlagen",
    "_Successfully uploaded {n} file_::_Successfully uploaded {n} files_" : ["{n} Datei wurde hochgeladen","{n} Dateien wurden hochgeladen"],
    "Uploaded {success} files, {failed} failed" : "{success} Dateien hochgeladen, {failed} fehlgeschlagen",
    "_Failed to upload {n} file_::_Failed to upload {n} files_" : ["{n} Datei konnte nicht hochgeladen werden","{n} Dateien konnten nicht hochgeladen werden"],
    ...
    "Download {ext}" : "{ext} herunterladen",
    "Slideshow" : "Diashow",
    "Previous" : "Zurück",
    "Next" : "Nächstes",
    ...
    "Choose the folders on this device to show on your timeline." : "Wähle die Ordner auf diesem Gerät aus, die auf deiner Zeitlinie angezeigt werden sollen.",
    "If no folders are visible here, you may need to grant the app storage permissions, or wait for the app to index your files." : "Wenn hier keine Ordner sichtbar sind, musst du möglicherweise der App Speicherberechtigungen erteilen oder warten, bis die App deine Dateien indiziert hat.",
    "You can always change this in settings. Note that this does not affect automatic uploading." : "Du kannst dies jederzeit in den Einstellungen ändern. Beachte, dass sich dies nicht auf das automatische Hochladen auswirkt.",
    "Synchronizing local files ({n} done)." : "Synchronisiere lokale Dateien ({n} fertig).",
    "This may take a while. Do not close this window." : "Das kann eine Weile dauern. Schließe dieses Fenster nicht.",
    "Finish" : "Beenden",
